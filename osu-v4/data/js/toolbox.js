...
jsonToolbox["contents"][3] = toolbox_standard["contents"][5];
jsonToolbox["contents"][4] = toolbox_standard["contents"][6];
...
Code.buildToolbox = function() {
	...
	if (toolboxIds === undefined || toolboxIds === "") {
		if (boardSelected) {
			toolboxIds = 'LOGIC,LOOPS,MOTOR,COLOUR,VARIABLES,FUNCTIONS,BOARD';
